@extends('layouts.app')
@section('title') Tambah Pencatatan Pembukuan Harian @endsection
    ...
    <div class="card-body">
        <form method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <select class="form-control" name="tipe_transaksi" id="tipe_transaksi" placeholder="Pilih Tipe Transaksi">
                        ...
                        <option value="bank">Bank / Transfer / Cheque Giro</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control numeric" name="nilai_transaksi" id="nilai_transaksi" placeholder="Nominal Transaksi" value="{{old("nilai_transaksi")}}" />
                </div>
            </div>
